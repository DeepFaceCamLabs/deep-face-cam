...
from modules.model_manager import ensure_model
...
def pre_check() -> bool:
    ...
    if not os.path.exists(model_path):
        ...
        if not ensure_model(MODEL_ID):
            update_status(f"Could not prepare {MODEL_FILE} in {models_dir}.", NAME)
            return False
    return True
